  ...
  return (
    ...
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="Tab" component={Tab} options={{ animation: 'ios' }} />
        ...
        <Stack.Screen name="Invite" component={Invite} options={{ animation: 'slide_from_right' }} />
        <Stack.Screen name="Join" component={Join} options={{ animation: 'slide_from_right' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}